...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # For fullscreen mode, uncomment the next line:
    ...
    def _check_bullet_alien_collisions(self):
        ...
        # Delete any bullets and aliens that have collided.
    ...
    def _create_fleet(self):
        ...
        # The alien width is used to determine the spacing between aliens.
        alien = Alien(self)
    ...
    def _update_screen(self):
        ...
        # Flip the screen to display the updated frame.
        pygame.display.flip()
